...
- Graphs and charts are everywhere
  - Statistical charts are a central way people engage with data [@schneider2024crisis]

:::: columns
::: {.column width="30%"}
![](images/Steps.png){width=80%}
:::
::: {.column width="55%"}
...
::: {.column width="15%"}
<small>@airnow_fire_smoke_map</small>
:::
::::
...
:::: columns
::: {.column width=50%}
- Fitting "by eye" [@mosteller1981eye]
...
![@schneider2024crisis](images/COVID Graph.png)
:::
:::
:::: 
